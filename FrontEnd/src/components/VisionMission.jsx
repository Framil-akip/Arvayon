...
const VisionMission = () => {
    return (
        <section className="py-20 bg-goldBg relative overflow-hidden">
            {/* Decorative elements */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {/* Vision */}
                    <div className="bg-primary p-10 rounded-xl border border-white/10 hover:border-accent transition-all duration-300 shadow-2xl hover:shadow-accent/20 relative group overflow-hidden">
