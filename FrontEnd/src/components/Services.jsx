                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:grid-rows-2 gap-4 h-auto lg:h-[700px]">
                    {servicesData.map((service, index) => (
                        <Link
                            ...
                            className={`group relative overflow-hidden rounded-2xl border border-white/10 hover:border-accent/50 transition-all duration-500 cursor-pointer ${service.className} min-h-[220px] md:min-h-[280px] lg:min-h-[320px] bg-center bg-cover`}
                        ...
                        >
                            ...
                            <div className="relative h-full p-6 flex items-center justify-center">
                                <span className="text-white text-2xl md:text-3xl font-extrabold uppercase tracking-widest drop-shadow-[0_2px_3px_rgba(0,0,0,0.6)] group-hover:text-accent transition-colors duration-300 text-center">
                                    {service.title}
                                </span>
                            </div>
                        </Link>
